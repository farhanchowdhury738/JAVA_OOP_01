...
public class menu extends JFrame {
    ...
    public menu()
    {
        ...
        l2 = new JLabel("Menu Showing : Cold Coffee!");
        ...
        //panel 3  image
        l3 = new JLabel(new ImageIcon(getClass().getResource("/image/dr1.jpg")));
        l3.setBounds(100,100,155,210);
        P3.add(l3);


        l4 = new JLabel(new ImageIcon(getClass().getResource("/image/dr2.jpg")));
        l4.setBounds(450,100,155,210);
        P3.add(l4);


        l5 = new JLabel(new ImageIcon(getClass().getResource("/image/r3.jpg")));
        l5.setBounds(100,270,155,210);
        P3.add(l5);


        l6 = new JLabel(new ImageIcon(getClass().getResource("/image/dr4.jpg")));
